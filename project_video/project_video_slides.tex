...
\begin{frame}{2) Environment and MDP}
  ...
  \vspace{0.5em}
  \textbf{Action (28-dim):} integer trades per stock
  \[
...
\begin{frame}{5) Interpretation, Limits, and Future Work}
...
\begin{frame}{6) Takeaways}
  \begin{itemize}
    ...
    \item \textbf{TD3 consistently outperforms DDPG} under the same setup.
